...
async function renderAgendamentoPage() {
    ...
    async function atualizarTabela() {
        ...
        const tableRows = aulas.map((aula)=>{
            ...
            if (role === "aluno") {
                if (aula.status === "aberta" && !jaAgendado) acoes = `<button class="btn btn-success" onclick="agendarAula('${aulaId}')">Agendar</button>`;
                else if (aula.status === "confirmada" && jaAgendado) acoes = `<button class="btn btn-danger" onclick="cancelarAula('${aulaId}')">Cancelar</button>`;
            } else if (role === "recepcionista") acoes = `<button class="btn btn-outline-success" onclick="abrirModalAlunos('${aulaId}')">Ver</button>`;
            else if (role === "instrutor") acoes = `<button class="btn btn-secondary" onclick="verAlunosInstrutor('${aulaId}')">Visualizar</button>`;
            return `
        <tr>
